...
#' `adjustr()` takes this relationship into account to calculate the number of scans needed to be performed on a sample to produce a spectrum with a certain signal to noise and is the value returned by the function.
#'
...
#' @examples
#' data(m)
#' ns <- adjustr(300000, 1500, 40000, m$a_NS, c(4,512,2))
